...
export const createRationalize = /* #__PURE__ */ factory(name, dependencies, ({
   ...
   *
   */
  const fullSig = 'Node, Object, boolean'
  return typed(name, {
    string: expr => _rationalize(parse(expr)),

    'string, boolean': function (expr, detailed) {
      return _rationalize(parse(expr), {}, detailed)
    },

    'string, Object': function (expr, scope) {
      return _rationalize(parse(expr), scope)
    },

    'string, Object, boolean': function (expr, scope, detailed) {
      return _rationalize(parse(expr), scope, detailed)
    },
