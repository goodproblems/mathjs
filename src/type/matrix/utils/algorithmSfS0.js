...
const name = 'algorithmSfS0'
const dependencies = ['typed', 'equalScalar']

export const createAlgorithmSfS0 = /* #__PURE__ */ factory(name, dependencies, ({ typed, equalScalar }) => {
  /**
   ...
   */
  return function algorithmSfS0 (a, b, callback) {
