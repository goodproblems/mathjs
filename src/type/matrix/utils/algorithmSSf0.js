...
const name = 'algorithmSSf0'
const dependencies = ['typed', 'equalScalar']

export const createAlgorithmSSf0 = /* #__PURE__ */ factory(name, dependencies, ({ typed, equalScalar }) => {
  /**
   ...
   */
  return function algorithmSSf0 (a, b, callback) {
