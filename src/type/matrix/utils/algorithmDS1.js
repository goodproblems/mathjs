...
const name = 'algorithmDS1'
const dependencies = ['typed']

export const createAlgorithmDS1 = /* #__PURE__ */ factory(name, dependencies, ({ typed }) => {
  /**
   ...
   */
  return function algorithmDS1 (denseMatrix, sparseMatrix, callback, inverse) {
    // dense matrix arrays
