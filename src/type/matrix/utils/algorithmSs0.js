...
const name = 'algorithmSs0'
const dependencies = ['typed', 'equalScalar']

export const createAlgorithmSs0 = /* #__PURE__ */ factory(name, dependencies, ({ typed, equalScalar }) => {
  /**
   ...
   */
  return function algorithmSs0 (s, b, callback, inverse) {
