...
const name = 'algorithmSSff'
const dependencies = ['typed', 'DenseMatrix']

export const createAlgorithmSSff = /* #__PURE__ */ factory(name, dependencies, ({ typed, DenseMatrix }) => {
  /**
   ...
   */
  return function algorithmSSff (a, b, callback) {
