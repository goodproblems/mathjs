...
const name = 'algorithmSS10'
const dependencies = ['typed', 'equalScalar']

export const createAlgorithmSS10 = /* #__PURE__ */ factory(name, dependencies, ({ typed, equalScalar }) => {
  /**
   ...
   */
  return function algorithmSS10 (a, b, callback) {
